        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="user-content">
                    <h3 style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-weight:700;">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label for=""><?php echo LANG_VALUE_108. ' (Optional) '; ?> *</label>
                                <input type="text" class="form-control" name="cust_state" value="<?php echo $_SESSION['customer']['cust_state']; ?>">
                            </div>
                            <div class="col-md-6 form-group">
                                <label for=""><?php echo LANG_VALUE_109. ' (Optional) '; ?> *</label>
